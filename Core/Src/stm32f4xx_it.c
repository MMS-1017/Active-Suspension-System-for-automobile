...
extern Motor_t MotorForwardSuspension;
extern Motor_t MotorBackwardSuspension;
...
void EXTI3_IRQHandler(void)
{
  /* USER CODE BEGIN EXTI3_IRQn 0 */
	MotorR_ICU(&MotorRight);
  /* USER CODE END EXTI3_IRQn 0 */
  HAL_GPIO_EXTI_IRQHandler(mr_enc1_Pin);
...
//	  }
  ...
  HAL_GPIO_EXTI_IRQHandler(mb_enc1_Pin);
  HAL_GPIO_EXTI_IRQHandler(mf_enc1_Pin);
...
void EXTI15_10_IRQHandler(void)
{
  /* USER CODE BEGIN EXTI15_10_IRQn 0 */
	MotorL_ICU(&MotorLeft);
  /* USER CODE END EXTI15_10_IRQn 0 */
  HAL_GPIO_EXTI_IRQHandler(ml_enc1_Pin);
